...
Person.prototype.getLeader = function(){
	console.log(this._email + ' is ' + this._placement + 'with leader who is a ' + Config.getLeader(this._placement) + ' whose email is ' + $(this._xml).find('semester[code=' + window.config.getCurrentSemester() + '] > people > person > roles > role[type=' + this._placement + '] > leadership > person[type=' + Config.getLeader(this._placement) + ']').attr('email'));
