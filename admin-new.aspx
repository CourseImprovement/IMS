					...
					<div class="twelve wide column">
						...
						<form class="ui form">
							<div class="field">
								...
								<input type="text" ng-model='evaluations.emailCol'>
							</div>
							<div class="field">
		  ...
		  <div class="content">
		    <form class="ui form">
		    	<div class="field">
		    		...
		    		<input type="text" ng-model='question.columnLetter'>
		    	</div>
		    	<div class="field">
		    	...
		    	<div class="field">
		    		<label>Replace What</label>
		    		<input type="text" ng-model='question.replaceWhat'>
		    	</div>
		    	<div class="field">
		    		<label>Replace With</label>
		    		<input type="text" ng-model='question.replaceWith'>
		    	</div>
		    </form>
		  </div>
		  <div class="actions">
